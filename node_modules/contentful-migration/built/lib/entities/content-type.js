...
class EditorInterfaces {
    ...
    addSidebarWidget(widgetId, widgetNamespace, insertBeforeWidgetId, settings, disabled) {
    ...
    updateSidebarWidget(widgetId, widgetNamespace, settings, disabled) {
        ...
        const widget = this._sidebar.find(widget => widget.widgetId === widgetId && widget.widgetNamespace === widgetNamespace);
        if (!widget) {
            return;
        }
    ...
    removeSidebarWidget(widgetId, widgetNamespace) {
        ...
        this._sidebar = this._sidebar.filter(widget => !(widget.widgetId === widgetId && widget.widgetNamespace === widgetNamespace));
    }
